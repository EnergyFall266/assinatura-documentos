...
Clique no search(Lupa) do vsCode e procure pela palavra "assinatura-documentos" e em replace digite o nome do seu projeto, clique no icone "replace all" e confirme. Por fim altere o titulo ProjetoPadrao no index.html.
...
```json
"build": {
            "outputPath": "dist/assinatura-documentos",
}
```
